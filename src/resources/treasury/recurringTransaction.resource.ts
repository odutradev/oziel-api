...
const createRecurringTransaction = async ({ data, createLog, ids, manageError }: ManageRequestBody) => {
...
const updateRecurringTransaction = async ({ params, data, createLog, ids, manageError }: ManageRequestBody) => {
...
const deleteRecurringTransaction = async ({ params, createLog, ids, manageError }: ManageRequestBody) => {
    const transactionID = params?.id as string;
    if (!transactionID) return manageError({ code: "invalid_params" as never });
...
const getAllRecurringTransactions = async ({ querys, manageError }: ManageRequestBody) => {
